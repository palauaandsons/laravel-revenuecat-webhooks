...
namespace PalauaAndSons\RevenueCatWebhooks\Exceptions;
...
class WebhookFailed extends Exception
{
    ...
    {
        return new static("Webhook call id `{$webhookCall->id}` did not contain a type. Valid RevenueCat webhook calls should always contain a type.");
    }
